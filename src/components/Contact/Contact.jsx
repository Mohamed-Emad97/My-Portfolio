          ...
          <div className="row">
            <div className="col-md-6">
              <div className="contactUs">
                <h4>Contact Info</h4>
                <p className='mb-0 fs-6 fw-bold text-black-50 center'><span className="icon text-black-50 fw-bold fs-5 me-2"><i class="fa-solid fa-envelope"></i></span>mohamedmassoud14872@gmail.com</p>
                <p className='tel fs-6 fw-bold text-black-50 center'><span className="icon text-black-50 fw-bold fs-5 me-2"><i class="fa-solid fa-phone"></i></span>01553640099</p>
              </div>
            </div>
            <div className="col-md-6">
